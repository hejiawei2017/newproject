...
Page({
  ...
  data: {
    ...
    // 轮播图数据
    swiperData: [
      'https://locals-house-prod.oss-cn-shenzhen.aliyuncs.com//localhomeqy/coupon59/WechatIMG606.png',
      'https://locals-house-prod.oss-cn-shenzhen.aliyuncs.com//localhomeqy/coupon59/WechatIMG607.png',
      'https://locals-house-prod.oss-cn-shenzhen.aliyuncs.com//localhomeqy/coupon59/WechatIMG608.png',
      'https://locals-house-prod.oss-cn-shenzhen.aliyuncs.com//localhomeqy/coupon59/WechatIMG609.png',
      'https://locals-house-prod.oss-cn-shenzhen.aliyuncs.com//localhomeqy/coupon59/WechatIMG610.png'
    ],
    // 已领取人数
    haveCount: 10000,
    // 成功弹窗
  ...
  onLoad: function(options) {
    ...
    wx.redirectTo({
      url: '/pages/activity/coupon59-201906/index'
    })
  ...
  shareTimeline() {
    wx.navigateTo({
      url: '/pages/activity/coupon29-201812/poster',
    });
  },
  ...
  // 随机生成人数
  getHaveCount(type) {
    const count = this.data.haveCount;
    if(type === 'add') {
      const random =  parseInt(Math.random() * 10);
      this.setData({
        haveCount: count + random
      })
    } else {
  ...
  onShareAppMessage() {
    ...
    return shareDataFormat({
      ...
      path: `/pages/activity/coupon29-201812/index?springRalationFromUserId=${
        userInfo.id
      }`,
      imageUrl:

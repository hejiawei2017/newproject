...
class SetCommonTemplate extends Component {
    constructor (props) {
        super(props)
        this.state = {
            contractType:"1501",
                            ...
                            <Row type="flex" justify="space-between" align="top">
                                <Col xs={13}>
                                    <FormItem style={{marginBottom:0}}>
                                        {getFieldDecorator(`temp-templatecol1-${k}`, {initialValue:contractType, rules: [{ required:true, message:'签约价不能为空' }]},
                                        )(
                                ...
                                <Col xs={6}>
                                    <FormItem style={{marginBottom:0}}>
                                        {getFieldDecorator(`temp-templatecol2-${k}`, {initialValue:"1",rules: [{ required:true, message:'签约价格不能为空' }]},
                                        )(
                                            <InputNumber
                                                min={1}
                                                max={10000}
...
let SetCommonTemplateNew = Form.create()(SetCommonTemplate)
export default connect(mapStateToProps)(SetCommonTemplateNew)

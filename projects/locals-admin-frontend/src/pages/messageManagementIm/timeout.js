...
class ImMessage extends Component {
    ...
    itemChange = (index,id,groupId,houseSourceId,bookingUserName,orderId,tenantNumber,checkInDate,checkOutDate,totalPrice,assistantName,assistantId,bookingUserId)=>{
                                ...
                                {self.state.dataList.length > 0 ?
                                    <div>
                                        <div className="timeout-msg">
                                            <p><span>客人：{self.state.bookingUserName}</span><span>助理：{self.state.assistantName}</span></p>
                                            {self.state.orderId ?
                                                <p className="red">
                                                    <span>预订已接受</span>

...
export const roleList = handleActions({//角色列表
    'SEARCH_ROLE_ING' (state, action) {
        return {...action.payload,loading: true}
    },
    'SEARCH_ROLE_SUCCESS' (state, action) {
        return {...action.payload,loading: false}
    }
}, [])

export const roleCodeList = handleActions({//拥有权限列表
    'QUERY_ROLECODE_ING' (state, action) {
        return {list:[],roleCode: action.payload.roleCode,roleName:'', loading: true}
    },
    'QUERY_ROLECODE_SUCCESS' (state, action) {
...
export const delRoleCode = handleActions({//刪除权限
    'DEL_ROLECODE_ING' (state, action) {
        return {loading: true}
    },
    'DEL_ROLECODE_SUCCESS' (state, action) {

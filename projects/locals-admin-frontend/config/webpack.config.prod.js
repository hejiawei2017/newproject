...
let myEnv = Object.assign(env.stringified, { 'process.env.MY_ENV': JSON.stringify(process.argv[2]) })
...
const webpackPlugins = [
  ...
  new MiniCssExtractPlugin({
    ...
    chunkFilename: "static/css/[chunkhash:8].css"
  })
]
...
if (buildMode === 'prod') {
  webpackPlugins.push(new FileManagerPlugin({
    onEnd: [
      {
        archive: [
          { source: `${paths.appBuild}/prod`, destination: `${paths.appBuild}/prod.zip` },
        ]
      },
      {
        delete: [
      ...
      },
      {
        oneOf: [
          ...
          },
          {
            ...
            exclude: [/\.bmp$/, /\.gif$/, /\.jpe?g$/, /\.png$/, /\.js$/, /\.html$/, /\.json$/, /\.scss$/, /\.less$/],
            options: {

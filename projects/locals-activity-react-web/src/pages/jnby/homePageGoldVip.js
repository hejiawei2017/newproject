...
export default class HomePage extends React.Component {
	...
	receive = async (e) => {
		...
		utils.gioTrack('jnby_gold_vip_apply_btn')
		...
		try {
			...
			const giftRes = await giftPack({mobiles: [mobile], giftPackCode: 'JNBYGOLD'}, options)
			if (!giftRes.success) {
				this.setState({loading: false})
	...
	backToHome = (e) => {
		e.stopPropagation()
		utils.gioTrack('jnby_gold_vip_back_to_home_btn')
		adapter.navigate({method: 'reLaunch', url: '/pages/index/index'})
	}

	render () {
		const {banners, discounts, isSend, time, loading, errorVisible, errorMsg, tipVisible, introductions, services} = this.state
		return (
			<div className="home-container">
				...
				<div className="home-body">
					<div className="discount-title-row">
						<span className="title">江南布衣用户专享</span>

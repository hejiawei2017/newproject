...
export default class HomePage extends React.Component {
	...
	receive = async (e) => {
		...
		utils.gioTrack('txj_gold_vip_apply_btn')
		...
		try {
			...
			await importStaffs({
				importitems: [{
					name: '',
					phone: mobile,
					importer: '13087573957',
					remark: '',
					position: '西安泰熙家餐饮管理有限公司'
				}]
			}, options)
	...
	backToHome = (e) => {
		e.stopPropagation()
		utils.gioTrack('txj_gold_vip_back_to_home_btn')
		this.setState({bookVisible: true})
	}

	render () {
		const {banners, discounts, isSend, time, loading, errorVisible, errorMsg, tipVisible, bookVisible, introductions, services} = this.state
		return (
			<div className="home-container">
				...
				{
					bookVisible &&
					<div className="mask" onClick={this.closeBookDialog}>
						<div className="book-dialog">
							<img className="book-dialog-img"
							     src="https://locals-house-prod.oss-cn-shenzhen.aliyuncs.com/localhomeqy/tai-xi-jia/book-dialog.png"
							     alt=""/>
						</div>
					</div>
				}

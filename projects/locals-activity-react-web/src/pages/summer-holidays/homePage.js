...
class App extends React.Component {
	...
	getWinnerResult = () => {
		let that = this;
		axios.get(`${Host}/report/index/previousPeriod`, {
			params: {
				...
				modalDom = (
					<div className="model resultNo">
						<div>
							...
							<img className="bg"
							     src="https://locals-house-prod.oss-cn-shenzhen.aliyuncs.com//localhomeqy/boost51/%E8%8E%B7%E5%BE%97%E8%B5%84%E6%A0%BC%E5%BC%B9%E7%AA%97.png"
							     alt=""/>
						</div>
						<img
						...
						<div>
							<div className="resultSucBox">
								<div className="result-content">
									<div className="resultList">上期获0元住美宿名单：{this.state.lastResult}</div>
									<div className="result-tip">请获奖的幸运用户留意来电，客服人员将在24小时内与您沟通订房事宜。</div>
								</div>
								<img className="bg"
								     src="https://locals-house-prod.oss-cn-shenzhen.aliyuncs.com//localhomeqy/boost51/WechatIMG94.png"
								     alt=""/>
							</div>
						</div>
						<img
			...
			<div className='app' id="app">
				...
				<div className="fixedBox">
					<div className="fixedBoxItem" onClick={this.activityRule}>
						<img
							src="https://locals-house-prod.oss-cn-shenzhen.aliyuncs.com//localhomeqy/boost51/%E6%B4%BB%E5%8A%A8%E8%A7%84%E5%88%99.png"
							alt=""/>
					</div>
					<div className="fixedBoxItem" onClick={this.winnerResult}>
						<img
							src="https://locals-house-prod.oss-cn-shenzhen.aliyuncs.com//localhomeqy/boost51/%E8%8E%B7%E5%A5%96%E7%BB%93%E6%9E%9C.png"
							alt=""/>
					</div>
				</div>
				<div className="homePage">
					<div className="panic_section">
						<div className="panicTitle">
							<p className="weightTitle">
								<span className="line"></span>·
								<span className="mainTitle">好友助力0元住，超赞美宿任你选</span>·
								<span className="line"></span>
							</p>
							{/*<p className="subTitle">暑假期间 每晚9:00准点开抢</p>*/}
						</div>
						<div className="renderImage">
							{
								houseListData.map((item, index) => {
									return (
										<div className={`headBox ${item.open ? '' : 'house-mask'}`} key={index}
										     onClick={function () {
				...
				<div className="house_section">
					<div className="panicTitle">
						<p className="weightTitle"><span className="line"></span>·<span
							className="mainTitle">爆款民宿，全国限时热抢</span>·<span className="line"></span></p>
						...
						<div className="tab_card">
							{
								tabDataInfo.map((item, index) => {
									return <div key={index}
									            className={`tab_card_item ${item.is_active === true && 'active'}`}
									            onClick={() => {
...

				{
					...
					<div className='ruleTips' onClick={this.closePanicTip.bind(this)}>
						<div className="model panic">
							<div className="resultSucBox" onClick={(e) => {
								this.entryOffer(e)
							}}>
								<img className="bg"
								     src="https://locals-house-prod.oss-cn-shenzhen.aliyuncs.com//localhomeqy/boost51/%E6%8A%A2%E5%88%B8%E6%88%90%E5%8A%9F.png"
								     alt=""/>
								<div className="model_text">
									<img
										src="https://locals-house-prod.oss-cn-shenzhen.aliyuncs.com//localhomeqy/boost51/%E6%8C%89%E9%92%AE%20%E6%8B%B7%E8%B4%9D.png"
							...
							<img
								src="https://locals-house-prod.oss-cn-shenzhen.aliyuncs.com//localhomeqy/boost51/%E5%85%B3%E9%97%AD.png"
								className="backBtn" onClick={this.closePanicTip.bind(this)} alt=''/>
						</div>
					</div>
				}
				...
				}
				{
					...
					<div className='ruleTips' onClick={this.closeRuleModel.bind(this)}>
						<div className="model rule">
							<img className="bg"
							     src="https://locals-house-prod.oss-cn-shenzhen.aliyuncs.com//localhomeqy/boost51/%E6%A0%87%E9%A2%98%20%E6%8B%B7%E8%B4%9D.png"
							     alt=""/>
							<div className="model_text">
								{
									<div className="auto_dialog">
										<p>一、好友助力0元住，超赞美宿任你选</p>
										<p>1.活动时间：即日起-2019.09.10 21:00</p>
										<p>2.参与方式：用户每天可以参与1次，点击立抢全国通兑券，邀请好友助力，助力人数最高者即为获奖用户。好友成功助力后，可获得50元无门槛立减券以及满1000减120优惠券。</p>
										<p>3.获奖公布：每期邀请助力的时间为每天21:00-次日20:59，每期获奖结果将于次日21:00公布，点击首页“获奖结果”按钮即可查看。</p>
										<p>4.奖品兑换：客服将在获奖名单公布后的24小时内与获奖用户沟通，请保持电话畅通。</p>
										<p>5.通兑券使用规则：通兑券适用于预定路客全国已上线房源，不抵扣清洁费、保证金等其他费用，仅限本人预订本人入住使用。其他详细使用规则以优惠券页面为准。</p>
										<p>注意：恶意刷榜用户将永久取消获奖资格</p>
										<p>二、爆款民宿，全国限时热抢</p>
										<p>房源展示价格为优惠后价格，实际价格以房源详情页为准</p>
										<p>*本活动最终解释权归路客所有</p>
									</div>
								}
							</div>
							<img
								src="https://locals-house-prod.oss-cn-shenzhen.aliyuncs.com//localhomeqy/boost51/%E5%85%B3%E9%97%AD.png"
								className="backBtn" onClick={this.closeRuleModel.bind(this)} alt=''/>
						</div>
					</div>
				}
				{this.renderModal()}

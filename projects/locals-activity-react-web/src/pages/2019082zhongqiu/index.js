    ...
    return (
      <div id="app" className="shuqiContainer">
        <div className="topImg">
          <img
            src="https://locals-house-prod.oss-cn-shenzhen.aliyuncs.com//localhomeqy/zhongqiu/topbg.png"
            alt=""
          />
        </div>
        <div className="main">
          <div className="receiveTicket">
            ...
            <img
              className="quan-img"
              src="https://locals-house-prod.oss-cn-shenzhen.aliyuncs.com//localhomeqy/zhongqiu/top-tick.png"
              alt=""
            />
            <img
              className="takeBtn"
              src="https://locals-house-prod.oss-cn-shenzhen.aliyuncs.com//localhomeqy/zhongqiu/lingqu.png"
          ...
          <div className="tabList">
            <div className="title">
              <img
                ...
                src="https://locals-house-prod.oss-cn-shenzhen.aliyuncs.com//localhomeqy/zhongqiu/frist-project-top.png"
                alt=""
              />
            </div>
            ...
            <img
              ...
              src="https://locals-house-prod.oss-cn-shenzhen.aliyuncs.com//localhomeqy/zhongqiu/look-more.png"
              alt=""
            />
          </div>
          ...
          <div className="tabList">
            <div className="title">
              <img
                className="frist-project-top"
                src="https://locals-house-prod.oss-cn-shenzhen.aliyuncs.com//localhomeqy/zhongqiu/hot-city.png"
                alt=""
              />
            </div>
            <div className="receiveTab">
              ...
              <div className="dialog">
                <div className="dialog-success">
                  <img
                    ...
                    src="https://locals-house-prod.oss-cn-shenzhen.aliyuncs.com//localhomeqy/zhongqiu/receive-success.png"
                    alt=""
                  />
              ...
              <div className="dialog">
                <div className="dialog-recived">
                  <div className="dialog-recived-container">
                    <img
                      className="dialog-img"
                      src="https://locals-house-prod.oss-cn-shenzhen.aliyuncs.com//localhomeqy/zhongqiu/have-take.png"
                      alt=""
                    />

    ...
    getCoupon(_data)
      .then(res => {
        if (res.success) {
          ...
          // 存下phone在storage
          window.gio && window.gio('track', 'shuqigetCoupon', 1)
    ...
    return (
      <div id="app" className="shuqiContainer">
        <div className="topImg">
          <img
            src="https://locals-house-prod.oss-cn-shenzhen.aliyuncs.com//localhomeqy/topbg.png"
            alt=""
          />
        </div>
        <div className="main">
          <div className="receiveTicket">
            <div className="title">
              <img
                ...
                src="https://locals-house-prod.oss-cn-shenzhen.aliyuncs.com//localhomeqy/shuqi20/top-tip.png"
                alt=""
              />
            </div>
            <img
              className="quan-img"
              src="https://locals-house-prod.oss-cn-shenzhen.aliyuncs.com//localhomeqy/shuqi20/top-tick.png"
              alt=""
            />
            <img
              className="takeBtn"
              src="https://locals-house-prod.oss-cn-shenzhen.aliyuncs.com//localhomeqy/shuqi20/lingqu.png"
          ...
          <div className="tabList">
            <div className="title">
              <img
                ...
                src="https://locals-house-prod.oss-cn-shenzhen.aliyuncs.com//localhomeqy/shuqi20/frist-project-top.png"
                alt=""
              />
            </div>
            ...
            <img
              ...
              src="https://locals-house-prod.oss-cn-shenzhen.aliyuncs.com//localhomeqy/shuqi20/look-more.png"
              alt=""
            />
          </div>
          ...
          <div className="tabList">
            <div className="title">
              <img
                className="frist-project-top"
                src="https://locals-house-prod.oss-cn-shenzhen.aliyuncs.com//localhomeqy/shuqi20/hot-city.png"
                alt=""
              />
            </div>
            <div className="receiveTab">
              ...
              <div className="dialog">
                <div className="dialog-success">
                  <img
                    ...
                    src="https://locals-house-prod.oss-cn-shenzhen.aliyuncs.com//localhomeqy/receive-success.png"
                    alt=""
                  />
              ...
              <div className="dialog">
                <div className="dialog-recived">
                  <div className="dialog-recived-container">
                    <img
                      className="dialog-img"
                      src="https://locals-house-prod.oss-cn-shenzhen.aliyuncs.com//localhomeqy/have-take.png"
                      alt=""
                    />
                    <img
                      className="dialog-img2"
                      onClick={this.jumpToCoupon}
                      src="https://locals-house-prod.oss-cn-shenzhen.aliyuncs.com//localhomeqy/look-quan.jpg"
                      alt=""
                    />
                  </div>
                  <div className="jumpToCoupon" onClick={this.jumpToCoupon} />

...
export default class HomePage extends React.Component {
	constructor (props) {
		...
		this.state = {
			...
			services: [
				{icon: `${OSS_PATH}/silver-icon0.png`, name: '订房折扣'},
	...
	receive = async (e) => {
		...
		utils.gioTrack('go_together_act_receive_btn')
		...
		try {
			...
			const giftRes = await giftPack({mobiles: [mobile], giftPackCode: 'YIQIZOU'}, options)
			if (!giftRes.success) {
				this.setState({loading: false})
	...
	backToHome = (e) => {
		e.stopPropagation()
		utils.gioTrack('go_together_act_back_to_home_btn')
				...
				<div className="home-body">
					<div className="discount-title-row">
						<img className="title-img silver-title"
						     src="https://locals-house-prod.oss-cn-shenzhen.aliyuncs.com/localhomeqy/businessTravel/go-together-title.png"
						     alt=""/>

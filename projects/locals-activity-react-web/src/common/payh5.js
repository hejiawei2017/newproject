(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('axios')) :( global.LocalsPay = factory(global.axios));
  ...
  ***************************************************************************** */
  ...
  var LocalsPay = (function () {
          ...
          return __awaiter(this, void 0, void 0, function () {
              ...
              return __generator(this, function (_a) {
                  switch (_a.label) {
                      ...
                      case 1:
                          result = _a.sent();
                          if (result.orderStatus === 'TRADE_SUCCESS') {
                          ...
                          if (data.tradeType === 'MWEB') {
                              ...
                              if (typeof WeixinJSBridge === "undefined") {
                                  if (document.addEventListener) {
                                      document.addEventListener('WeixinJSBridgeReady', function () { _this.onBridgeReady(result, orderInfo.id); }, false);
                                  }
                                  else if (DOC.attachEvent) {
                                      DOC.attachEvent('WeixinJSBridgeReady', function () { _this.onBridgeReady(result, orderInfo.id); });
                                      DOC.attachEvent('onWeixinJSBridgeReady', function () { _this.onBridgeReady(result, orderInfo.id); });
                                  }
                              }
                              else {
                                  this.onBridgeReady(result, orderInfo.id);
                              }
                          }
                          return [2];
                  }
      ...
      LocalsPay.prototype.onBridgeReady = function (wxConfig, outTradeNo) {
          var _this = this;
          window.WeixinJSBridge.invoke('getBrandWCPayRequest', {
              "appId": wxConfig.appId,
              "timeStamp": wxConfig.timeStamp,
              "nonceStr": wxConfig.nonceStr,
              "package": wxConfig.pkg,
              "signType": wxConfig.signType,
              "paySign": wxConfig.paySign
          }, function (res) {
              if (res.err_msg == "get_brand_wcpay_request:ok") {
                  window.location.href = _this.getReturnUrl(outTradeNo);
              }
              else if (res.err_msg == "get_brand_wcpay_request:fail") {
                  _this.performCallback('支付失败');
              }
          });
      };
                  ...
                  switch (_a.label) {
                      case 0:
                          ...
                          data = {
                              ...
                              currency: "CNY",
                              source: "MALL",
                              returnUrl: this.getReturnUrl(orderInfo.id)
                          };
                          return [4, this.fetch("pay-center/pay", {
                                  method: "POST",
                                  data: data
                      ...
                      case 1:
                          ...
                          if (!result.errorMsg) {
                              ...
                              this.performCallback(result.errorMsg);
                          }
                          return [2];
                  }
              });
      ...
      LocalsPay.prototype.getReturnUrl = function (outTradeNo) {
          if (!this.returnUrl) {
              return this.returnUrl;
          }
          var url = '';
          if (this.returnUrl.indexOf('?') === -1) {
              url = this.returnUrl + ("?_outTradeNo=" + outTradeNo);
          }
          else {
              url = this.returnUrl + ("&_outTradeNo=" + outTradeNo);
          }
      ...
      LocalsPay.prototype.performCallback = function (errorMsg) {

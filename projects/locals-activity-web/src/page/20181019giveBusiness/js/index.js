    ...
    $.ajax({
      ...
      success:function(res){
          if(res.success){
            ...
            // $(".mine-code").css('display','none')
            $(".index-code").css('display','flex')
            // alert('恭喜您成功领取路客会员VIP，会员权益将在24小时内发送到您的账户，敬请期待！查看权益请前往公众号“locals路客精品民宿”点击“精彩房源”→点击“我的”，即可查看权益。如有疑问，请咨询公众号客服。')
...
// 发送邮件
  function sendEmail(info,params){
    ...
    $('#btn-mine').click(function(){
        $('.miniCode-mask').css('display','flex')
        $(".index-code").css('display','none')
        // $(".mine-code").css('display','flex')
    })
    // 阻止冒泡
    $('.index-code').click(function(e){
        e.stopPropagation()
    })
});

...
const map = {
  tooltip: {
    ...
    formatter: function(params) {
      let a = "<span>" + params.name + "<span/>";
      let b = params.value && params.value.length>2?
        "<span style=\"color:" + "rgba(23, 240, 204)" + "\">" + params.value[2] + "</span>" :
        "<span style=\"color:" + "rgba(23, 240, 204)" + "\">0</span>";
      return [a, b].join(":");
    },
  ...
  //   bottom: 30,
  //   left: 20,
  //   color: ['#fec262', '#00d8c1', '#fc95e8', '#e76262', '#48a8ff'],
  ...
  series: [
    ...
    //   map: "world",
    //   // aspectScale: 0.9,
    //   // itemStyle: { areaColor: "#bababa", borderColor: "#f6f6f6" },
    //   label: {
    //     normal: {
    //       show: false
    //     },
